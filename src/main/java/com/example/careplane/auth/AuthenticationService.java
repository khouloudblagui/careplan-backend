    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
     ...
     /* public ResponseEntity<String> register(RegisterRequest request) {
        if (request instanceof AdminDto) {
            return ResponseEntity.badRequest().body("Registration of admins is not allowed here.");
        } else {
...
public class AuthenticationService {
    ...
    public Response register(RegisterRequest userRequest, final HttpServletRequest request) {
        ...
        publisher.publishEvent(new RegistrationCompleteEvent((Admin) saveUsers, applicationUrl(request)));
